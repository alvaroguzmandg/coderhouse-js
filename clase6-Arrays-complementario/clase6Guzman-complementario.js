...
corredoresRegistrados.push(new Corredor("Mariano", "Tabanera", 31, 1, "Corral B"));
...
function ordenarPorApellido() {
    corredoresRegistrados.sort((a, b) => {
        if (a.apellido < b.apellido) {
            return -1;
        }
        if (a.appellido > b.apellido) {
            return 1;
        }
        return 0;
    })
...
ordenarPorEdad()
console.log(corredoresRegistrados)
ordenarPorApellido()
console.log(corredoresRegistrados)
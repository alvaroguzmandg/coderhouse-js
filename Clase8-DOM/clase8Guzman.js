...
function respuestaClick() {
    ...
    document.getElementById("tituloEventos").style.display = "none";
    document.getElementById("fotoEvento").style.display = "none";
    ...
    <h2>¡${corredor.nombre} gracias por registrarte!</h2>
    <span class="registro_inscripcion">INFORMACIÓN DE REGISTRO</span>
    ...
    <span class="info_titulo">CORRAL DE LARGADA</span>
    <span class="info_corredor">${corredor.corral}</span>
    `;
